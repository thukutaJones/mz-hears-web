...
import { addOperatorFields } from "@/contants/formFields";
...
const AddOperator = ({
  ...
  const handleAdd = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await axios.post(`${baseUrl}/api/v1/operator`, payload);
      handlSuccess("Operator added successfully");
      await callBack();
          ...
          <div className="w-full flex flex-col items-center justify-center">
            ...
            >
              ...
              >
                ...
                {addOperatorFields.map((field: any, index: number) => (
                  <FormField
                    key={index?.toString()}
                    field={field}
                    value={
